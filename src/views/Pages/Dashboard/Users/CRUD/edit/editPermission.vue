  ...
  <div>
    <template>
      ...
      >
        ...
        <v-card>
          <v-card-title>
            <span class="headline create__user__headline">Edit Permission</span>
          </v-card-title>
          <v-form
...
export default {
  ...
  watch: {
    getDialogPermissionEditClose(newValue) {
      if (newValue == 1) {
  ...
  computed: {
    ...mapGetters("authorization", [
      "getDialogPermissionEditClose",
      "getPermissionEditErrorMessage",
  ...
  methods: {
    ...
    duplicateSetPreviousData(editPermissionData) {
      this.editPermissionData.isActive = editPermissionData.isActive;
      this.editPermissionData.label = editPermissionData.label;
      this.editPermissionData.id = editPermissionData.id;
      this.form = Object.assign({}, this.editPermissionData);
    },
    ...
    submit() {
      this.$store.dispatch('authorization/editPermission', this.form)
